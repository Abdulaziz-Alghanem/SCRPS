...
scrps__inlaa <- function(inla_result, n = 10000,
                       test_data = NULL,
                       full_y = NULL,
                       test_idx = NULL,
                       only_test_data = TRUE,
...
#' @examples
#' #to be completed
scrps.inla <- function(inla_result, n = 10000,
                            test_data = NULL,
                            full_y = NULL,
                            test_idx = NULL,
                            only_test_data = TRUE,
  ...
  if(parallelize){
    ...
    score = foreach::`%dopar%`(foreach::foreach(i = test_idx_complete), {
      ...
      temp <- inla_score_for_i(inla_result = inla_result, y = y_complete[i], s = s[i], i = i, n = n)
      score = mean(temp)
      return(score)
    })
...
inla_score_for_i <- function(inla_result, y, s, i, n) {
